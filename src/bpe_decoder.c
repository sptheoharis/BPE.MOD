...
void SegmentBufferFlushDecoder(StructCodingPara *StrCoding) // flush codes and reset
{
   ...
   //
   // nkeffix : Pad to CodewordLength as specified in 122x0b1c3 section 4.2.5.1
   //
...
void DecoderEngine(StructCodingPara * PtrCoding)
{
   ...
   StructFreBlockString* pStrToFree;
   ...
   for(;;)
   {
      ...
      // nkeffix : Implement dcstop as specified in 122x0b1c3 section 4.2.3.2.5
   ...
   do{
      ...
      //
      // nkeffix : Free Previous StrFreBlockString
      //
