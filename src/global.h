...
#define MAX_SEGMENT_SIZE 134217728  // 2^27
//////////////////////////////////////////////////////////////////////////////
...
typedef struct CODINGPARAMETERS
{
   ...
   char InputFile[MAX_FILE_NAME_SIZE];
   char CodingOutputFile[MAX_FILE_NAME_SIZE];
   BOOL altStrageStop; // Alternative stage stop
} StructCodingPara;
